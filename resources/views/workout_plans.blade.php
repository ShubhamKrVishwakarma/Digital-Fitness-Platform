    ...
    <div class="bg-dark text-light pb-4">
        ...
        <section class="container mb-5 " id="workout-profile">
            ...
            <div class="content">
                <div class="pt-5">
                    <div class="data-1">
                        <p>Weekly Goal <span class="small-icons"><img src="{{asset('./images/workout/edit (1).png')}}./images/workout/edit (1).png"
                                    alt=""></span>
                        </p>
        ...
        <section class="container" id="main-section-1">
                ...
                @for($i = 0; $i < $plans->count(); $i++)
                    ...
                    <a href="{{route('workout', $plans[$i]->id)}}">
                        <div class="image-group mb-4 ">
                            ...
                            <span>
                                <p class="text-start text-light text-capitalize ">{{ $plans[$i]->name }} <br>16 Exercises <br>
